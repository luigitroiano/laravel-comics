...
<form action="{{route('admin.novels.store')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="name" id="name" class="form-control" placeholder="Novel Title" aria-describedby="helpId" required>
  ...
  <div class="form-group">
    ...
    <input type="number" min="1" max="100" step="0.01" name="price" id="price" class="form-control" placeholder="Novel price" aria-describedby="helpId" required>
    <small class="text-muted">Insert Novel price E.g: 18,99</small>
  </div>
  {{-- INPUT AVAILABLE --}}
  <div class="form-group">
    <label for="available">Availability</label>
    <input type="number" min="0" max="1" name="available" id="available" class="form-control" placeholder="Availability" aria-describedby="helpId" required>
    <small class="text-muted">Choose: '0' -> not available || '1' -> available</small>
  </div>
  {{-- INPUT ON SALE DATE --}}
  <div class="form-group">
    <label for="on_sale_date">On sale date</label>
    <input type="date" name="on_sale_date" id="on_sale_date" class="form-control" placeholder="Insert a date" aria-describedby="helpId" required>
    <small class="text-muted">Insert on sale date</small>
  </div>
  {{-- INPUT VOLUME --}}
  <div class="form-group">
    <label for="volume">Novel volume</label>
    <input type="number" min="1" max="100" name="volume" id="volume" class="form-control" placeholder="Insert the volume" aria-describedby="helpId" required>
    <small class="text-muted">Insert Novel's volume</small>
  </div>
  {{-- INPUT TRIM SIZE --}}
  <div class="form-group">
    <label for="trim_size">Novel's trim size</label>
    <select name="trim_size" id="trim_size" class="form-control" placeholder="Trim size" aria-describedby="helpId" required>
  ...
  <div class="form-group">
    ...
    <input type="number" min="50" max="150" name="page" id="page" class="form-control" placeholder="Number of pages" aria-describedby="helpId" required>
    <small class="text-muted">Insert the the number of pages</small>
  </div>
  {{-- INPUT RATE --}}
  <div class="form-group">
    <label for="rated">Novel's rate</label>
    <select name="rated" id="rated" class="form-control" placeholder="Rate" aria-describedby="helpId" required>
